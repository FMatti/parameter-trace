...
\end{equation}
with the expansion coefficients $\mu_0(t), \dots, \mu_m(t) \in \mathbb R$ and the Chebyshev polynomials
...
\end{equation}
Inserting~\refequ{equ:matrix-expansion} into~\eqref{equ:smooth-spectral-density} yields the approximate smoothed spectral density
\begin{equation}
