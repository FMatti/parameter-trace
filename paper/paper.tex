...
\begin{itemize}
 \item Capitalize references to algorithms, lemma etc (that is, Lemma 3.2 instead of lemma 3.2 [Lin17, Algorithm 1] instead of [Lin17, algorithm 1]), etc. \textcolor{green}{Done.}
 \item Add full stops after paragraph titles. \textcolor{green}{Done.}
 ...
 \item Please include Acknowledgements as indicated in the comment. \textcolor{green}{Done.}
\end{itemize}
}
\color{blue}
\input{intro.tex}
