...
\begin{proof}
    ...
    \begin{equation}
        ...
        \end{pmatrix}.
    \end{equation}
    Note that $\Trace(\mtx{B}(t)) - \Hutch{\mtx{\Psi}}(\mtx{B}(t)) =  \Trace(\widetilde{\mtx{B}}(t)) - \widetilde{\vct{\psi}}^{\top} \widetilde{\mtx{B}}(t) \widetilde{\vct{\psi}}$, $\lVert \widetilde{\mtx{B}}(t) \rVert _2 = \lVert \mtx{B}(t) \rVert _2 / n_{\mtx{\Psi}}$ and $\lVert \widetilde{\mtx{B}}(t) \rVert _F = \lVert \mtx{B}(t) \rVert _F / \sqrt{n_{\mtx{\Psi}}}$ hold. Therefore, by \reflem{lem:hutchinson-sub-exponential}, $\Trace(\mtx{B}(t)) - \Hutch{\mtx{\Psi}}(\mtx{B}(t))$ is a centered, $(2 \lVert \mtx{B}(t) \rVert _F^2 \frac{1}{1 - 1/c} / n_{\mtx{\Psi}}, 2 \lVert \mtx{A} \rVert _2 c / n_{\mtx{\Psi}})$-sub-exponential random variable for any $c > 1$. Thus, we can apply \reflem{lem:sub-exponential-moments} to bound
    \begin{equation}
