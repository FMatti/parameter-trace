...
%    \end{equation}
    ...
    \end{align}
    This implies~\refequ{eq:ghbound} by Markov's inequality.
...
%
    ...
    As in the proof of~\refthm{thm:hutchinson}, the claimed bound~\refequ{qu:nystrompp-theorem-bound}
    follows from~\refequ{eq:blubber} using Minkowski's integral inequality and Markov's inequality.
%     
%     
%         
