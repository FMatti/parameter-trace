...
\begin{remark}
    A variant of \refthm{thm:hutchinson} can be derived when assuming that $\mtx{B}(t)$ isSPSD and nonzero for every $t \in [a, b]$. After dividing both sides of \refequ{equ:moment-bound-hutchinson} by $\Trace(\mtx{B}(t))$, one can apply the remaining steps of the proof to deduce that
    \begin{equation*}
