...
# Set parameter
n_Omega_list = np.array([8, 8, 4, 4, 40])    # b
n_Psi_list = np.array([0, 13, 6, 6, 40])    # m
n_iter_list = np.array([30 + 50, 30 + 50, 30 + 50, 10 + 50, None])  # q
...
markers = ["d", "p", "^", "o", "s"]
labels = ["KA (i)", "KA (iii)", "KA (iv)", "KA (v)", "CN++"]
