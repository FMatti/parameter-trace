...
\end{equation}
The potential $V$ interacting with the electrons is generated by Gaussian wells
\begin{equation}
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Periodic Gaussian well potential $V$ for different sizes of the supercell.}
