...
\begin{proof}
    ...
    \end{align}
    We can apply \reflem{lem:ose} with $\mtx{A} = \mtx{\Lambda}_2^{\sfrac{1}{2}}$ to bound the first term with
    \begin{equation}
