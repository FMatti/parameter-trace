...
We first consider the Girard-Hutchinson estimator \refequ{equ:hutchinson-trace-estimator}. We bound its $L^1$ norm in terms of the integral over the Frobenius norm $\lVert \cdot \rVert _F$ of the matrix whose trace we aim to approximate.
...
The pseudoinverses on \reflin{lin:4-nystromchebyshev-nystrom-pp} need to be computed with care.
