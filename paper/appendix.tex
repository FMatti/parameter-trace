...
In this section we will bound the high order moments of single-query Girard-Hutchinson estimator \refequ{equ:hutchinson-trace-estimator}, i.e. when $n_{\mtx{\Psi}} = 1$. This bound is used in the proof of \refthm{thm:hutchinson}.
